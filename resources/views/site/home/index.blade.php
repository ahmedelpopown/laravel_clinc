                ...
                <div class="row gap-2">
                    <div class="col-sm order-sm-2">
                        <!-- <img src="assets/images/banner.jpg" class="img-fluid banner-img banner-img" alt="banner-image" -->
                            <!-- height="200"> -->
                        <img src="{{asset("images/banner.jpg")}}" class="img-fluid banner-img banner-img" alt="banner-image"  
                             height="200">  
                    </div>
        ...
        <div class="banner container d-block d-lg-grid d-md-block d-sm-block">
            <div class="info">
                <div class="info__details">
                    <img src="{{asset('https://d1aovdz1i2nnak.cloudfront.net/vezeeta-web-reactjs/55619/_next/static/images/medical-care-icon.svg')}}"
            ...
            <div class="bottom--right bg-blue text-white">
                <img src="{{asset('images/banner.jpg')}}" class="img-fluid banner-img">
            </div>
        </div>
@endsection
